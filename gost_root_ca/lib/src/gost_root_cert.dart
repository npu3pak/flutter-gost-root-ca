...
///
/// ВНИМАНИЕ: это единственный источник сертификата для dart:io (HttpOverrides)
/// и iOS (MethodChannel). Android хранит свою копию (PEM-текст) в
/// gost_root_ca_android/android/src/main/res/raw/gost_russian_trusted_root_ca.pem
/// для Network Security Config. При ротации корня обновлять ОБА файла.

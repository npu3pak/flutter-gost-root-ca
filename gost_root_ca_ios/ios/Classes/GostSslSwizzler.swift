...
/// 2. WKWebView: navigationDelegate оборачивается в NSProxy, добавляющий
///    обработку server trust challenge с теми же якорями (сетевой стек WebKit
...
/// `enableGostSsl`. Тайминг не критичен: свиззл `+[NSURLSession sharedSession]`
